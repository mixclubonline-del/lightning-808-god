...
export const ApolloEnvelope = ({
  ...
  return (
    <div className="bg-synth-panel rounded-lg border-2 border-yellow-600/50 p-4 shadow-[0_0_15px_rgba(202,138,4,0.3)] marble-texture sacred-geometry deity-aura">
