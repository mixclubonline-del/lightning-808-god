...
export const AthenaEye = ({ activeLayer }: AthenaEyeProps) => {
  ...
  return (
    <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-20">
      <div className="flex items-center gap-2 bg-synth-panel/90 backdrop-blur-sm px-4 py-2 rounded-lg border border-slate-400 shadow-[0_0_20px_rgba(148,163,184,0.6)] animate-scale-in olympian-backdrop deity-aura">
