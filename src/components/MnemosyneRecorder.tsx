    ...
    <div className="flex gap-3 items-center justify-center">
      {!isRecording ? (
        <button
          ...
          className="px-4 py-2 bg-amber-500/20 border-2 border-amber-500 text-amber-400 rounded-lg hover:bg-amber-500/30 transition-all shadow-[0_0_15px_rgba(245,158,11,0.4)] hover:shadow-[0_0_25px_rgba(245,158,11,0.6)] flex items-center gap-2 uppercase tracking-wider text-sm font-medium"
          style={{
